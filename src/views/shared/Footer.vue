<template>
  <footer class="footer-bg" id="customFooter">
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-xl-4 col-lg-4 col-sm-6">
            <div class="footer-widget widget_nav_menu">
              <h4 class="fw-title">{{ t("courses.coursesNav") }}</h4>
              <ul class="list-wrap">
                <li
                  v-for="(item, index) in featuredCourses.slice(0, 5)"
                  :key="index"
                  :href="item.title"
                >
          ...
          <div class="col-xl-3 col-lg-4 col-sm-6">
            <div class="footer-widget">
              <h4 class="fw-title">{{ t("footer.Contact") }}</h4>
